...
1. Launch `PCLocker.exe` — UAC elevation is requested automatically (required for the keyboard hook)
2. The control panel appears at screen centre
3. Click **Lock PC** to activate the overlay
4. Unlock with the keyboard shortcut or click **Unlock with password** on any screen
...
Made by Riccardo Nessi — [Stage Tools](https://stage-tools.github.io)
